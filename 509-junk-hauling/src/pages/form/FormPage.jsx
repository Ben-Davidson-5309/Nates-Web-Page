          ...
          >
            <div className="row g-4">
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="name">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="email">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="phone">
                    Phone Number
                  </label>
                  <input
                    type="tel"
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="address">
                    Address
                  </label>
                  <input
                    type="text"
                ...
                <div className="row">
                  <div className="col-6 mb-3">
                    <label className="form-label fw-semibold text-success" htmlFor="state">
                      State
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-6 mb-3">
                    <label className="form-label fw-semibold text-success" htmlFor="zip">
                      ZIP Code
                    </label>
                    <input
                      type="text"
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="cc-number">
                    Credit Card Number
                  </label>
                  <input
                    type="text"
                ...
                <div className="row g-2">
                  <div className="col-8 mb-3">
                    <label className="form-label fw-semibold text-success" htmlFor="cc-expiration">
                      Expiration Date
                    </label>
                    <input
                      type="month"
                  ...
                  <div className="col-4 mb-3">
                    <label className="form-label fw-semibold text-success" htmlFor="cc-cvv">
                      CVV
                    </label>
                    <input
                      type="text"
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold text-success" htmlFor="notes">
                    Additional Notes
                  </label>
                  <textarea
                    name="notes"
            ...
            <div className="text-center mt-4">
              ...
              <button
                type="button"
                className="btn btn-outline-success btn-lg px-5 ms-3"
